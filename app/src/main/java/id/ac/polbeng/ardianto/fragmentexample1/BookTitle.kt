package id.ac.polbeng.ardianto.fragmentexample1
...
import id.ac.polbeng.ardianto.fragmentexample1.databinding.BookTitlesBinding
...
class BookTitle : Fragment(), View.OnClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        //diambil dari id book_xml
        binding.learnAp.setOnClickListener(this)
        binding.learnWithKotlin.setOnClickListener(this)
